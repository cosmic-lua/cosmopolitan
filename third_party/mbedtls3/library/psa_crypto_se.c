...
#include "third_party/mbedtls3/include/psa/crypto_se_driver.h"
...
#error "cosmo: psa/error.h belongs to external SE drivers, not vendored"
#error "cosmo: third_party/mbedtls3/include/psa/internal_trusted_storage.h is not vendored"
#endif
