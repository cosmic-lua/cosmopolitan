...
return {
  ...
  ["tool/net/lfuncs.c"] = { defined = 66, covered = 45 },
  ["tool/net/lgetopt.c"] = { defined = 3, covered = 3 },
  ["tool/net/ljson.c"] = { defined = 4, covered = 2 },
  ["tool/net/llua.c"] = { defined = 11, covered = 11 },
  ["tool/net/lpath.c"] = { defined = 9, covered = 4 },
  ["tool/net/lre.c"] = { defined = 9, covered = 9 },
  ["tool/net/lsqlite3.c"] = { defined = 105, covered = 36 },
