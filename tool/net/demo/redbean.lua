...
local function main()
   ...
   Write('<dt>captures[1]\r\n')
   Write('<dd>')
   Write("%q" % {r.captures[1]})
   Write('\r\n')
   Write('<dt>captures[2]\r\n')
   Write('<dd>')
   Write("%q" % {r.captures[2]})
   Write('\r\n')
   Write('<dt>captures[3]\r\n')
   Write('<dd>')
   Write("%q" % {r.captures[3]})
   Write('\r\n')
   Write('<dt>captures[4]\r\n')
   Write('<dd>')
   Write("%q" % {r.captures[4]})
   Write('\r\n')
   Write('</dl>\r\n')
